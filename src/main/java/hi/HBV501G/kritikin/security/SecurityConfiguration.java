...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.cors()
                ...
                .antMatchers(HttpMethod.POST, APIURL + "/companyUser/**").authenticated()
                .antMatchers(HttpMethod.POST, APIURL + "/company/**/answer/**").hasAnyRole("COMPANY", "ADMIN")
                .antMatchers(HttpMethod.PATCH, APIURL + "/company/**").hasAnyRole("COMPANY", "ADMIN")
                ...
                .antMatchers(HttpMethod.PATCH, APIURL + "/users/**").hasRole("ADMIN")
                .and().httpBasic()
